...
import com.example.registration.databinding.ActivitySignUpInBinding
...
class SignInUpAct : AppCompatActivity() {
    ...
    fun onClickDone(view: View){
        ...
        if(signState == Constance.SIGN_UP_STATE){
            ...
            if(bindingClass.imAvatar.isVisible)intent.putExtra(Constance.AVATAR_ID, R.drawable.boy)
